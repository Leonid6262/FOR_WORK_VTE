...
inline std::vector<menu_alias::o> MENU_Factory(CADC_STORAGE& pAdc, CEEPSettings& rSet, 
  ...
  o(Mn.SETTINGS[l],{
      ...
      o(Mn.WORK[l], {
          ...
          o("Iset'",   {}, &set.work_set.derivIset,un::ApS, cd::cdr.Id, p0, vt::ushort, nm::Ed1V, 0, set.params.IdNom/4),
      ...
      o("doutCPU-SPI~",{
          ...
          o("Res",             {}, &set.dout_spi_invert[static_cast<char>(sbon::CPU_SPI)], "", cd::one, p0, vt::eb_1, nm::Ed1V),
          o("Res",             {}, &set.dout_spi_invert[static_cast<char>(sbon::CPU_SPI)], "", cd::one, p0, vt::eb_2, nm::Ed1V),  
          o("Res",             {}, &set.dout_spi_invert[static_cast<char>(sbon::CPU_SPI)], "", cd::one, p0, vt::eb_3, nm::Ed1V),
